	...
	<body>
		<div class="loginBox"> 
			...
			<form action="login.php" method="POST">
				<p id="uv"></p><br><br>
				<p>username</p>
				<input type='text' name='username' id="user" required style="width: 240px; border-radius: 10%; height: 30px;">
				<p>Password</p>
				<input type="password" name="password" required id="pass"  placeholder="" id="pword">
