  ...
  <div class="w3-row-padding">
    ...
    <div class="w3-twothird">
      ...
      <div class="w3-container w3-card w3-white w3-margin-bottom">
        <h2 class="w3-text-grey w3-padding-16"><i class="fa fa-suitcase fa-fw w3-margin-right w3-xxlarge w3-text-teal"></i>Admin's Panel</h>
          <h3 class="w3-text-grey w3-padding-16">Activities of Users:- </h3>
    ...
    <tbody>
      ...
      if($con){
        ...
        //3.query writing
        $sql="SELECT * FROM tasks where admin_uid='$user_uid'";
        //4.query execution
...
?>
    <tr>
        ...
        <td><?php echo $project['task_user']; ?></td>
        <td><?php echo $project['deadline']; ?></td>\
        <td><?php echo $project['body']; ?></td>
        <td><form action="delete.php" method="POST"><input type="hidden" name="task_id" 
value="<?php echo $project['task_id']; ?>">
<input type="submit" class="btn btn-danger" value="Delete"></button></form></td>
