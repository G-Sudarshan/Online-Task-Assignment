  ...
  <table class="table table-striped">
    ...
    <tbody>
      ...
      if($con){
        ...
        //3.query writing
        $sql="SELECT * FROM tasks where user_uid='$user_uid'";
        //4.query execution
...
?>
    <tr>
        ...
        <td><?php echo $project['task_admin']; ?></td>
        <td><?php echo $project['body']; ?></td>
        <td><form action="done.php" method="POST"><input type="hidden" name="task_id" 
value="<?php echo $project['task_id']; ?>">
<input type="submit" class="btn btn-success" value="Done"></button></form></td>
    </tr>
<?php
    }
  }
